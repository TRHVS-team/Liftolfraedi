...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{label}\NormalTok{(wcgs_dat}\OperatorTok{$}\NormalTok{dibpat) <-}\StringTok{ "Hegðunarhópur"}
\StringTok{label(wcgs_dat$agec) <- "}\NormalTok{Aldur}\StringTok{"}
\StringTok{label(wcgs_dat$cholmmol) <- "}\NormalTok{Kólestról"}
\KeywordTok{label}\NormalTok{(wcgs_dat}\OperatorTok{$}\NormalTok{sbp10) <-}\StringTok{ "Blóðþrýstingur"}
\StringTok{label(wcgs_dat$smoker) <- "}\NormalTok{Reykingar}\StringTok{"}
\StringTok{label(wcgs_dat$bmi) <- "}\NormalTok{BMI}\StringTok{"}
\StringTok{label(wcgs_dat$arcus0) <- "}\NormalTok{Hornhimnubogi}\StringTok{" ## !!! ATH er þetta rétt íslenska?}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{BOK_files/figure-latex/unnamed-chunk-13-1.pdf}
...
\includegraphics{BOK_files/figure-latex/unnamed-chunk-14-1.pdf}
...
\includegraphics{BOK_files/figure-latex/unnamed-chunk-20-1.pdf}
...
\includegraphics{BOK_files/figure-latex/unnamed-chunk-24-1.pdf}
...
\includegraphics{BOK_files/figure-latex/unnamed-chunk-25-1.pdf}
